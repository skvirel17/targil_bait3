...
public class TreatmentListOptionDTO extends Treatment {
    ...
    public static TreatmentListOptionDTO map(Treatment treatment) {
        return new TreatmentListOptionDTO(
                treatment.getSerialNumber(),
                treatment.getDescription(),
                treatment.getMedicationsList(),
                treatment.getDoctorsList(),
                treatment.getMedicalProblemsList()
        );
    }

    @Override
    public String toString() {
        // Example of how to format the string, modify as needed
        return "Treatment #" + getSerialNumber() + ": " + getDescription();
    }
}
