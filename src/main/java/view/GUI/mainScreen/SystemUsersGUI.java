package view.GUI.mainScreen;

import view.GUI.menu.*;
import view.GUI.panels.*;
import view.GUI.panels.table_panels.*;
import view.GUI.panels.table_panels.edit_panels.*;
import view.GUI.session.Session;
...
import static view.GUI.panels.DashBoardPanel.DASHBOARD_PANEL;
...
import static view.GUI.panels.LoginPanel.LOGIN_PANEL;
...
import static view.GUI.panels.table_panels.DepartmentsPanel.DEPARTMENTS_PANEL;
import static view.GUI.panels.table_panels.MedicalProblemsPanel.MEDICAL_PROBLEMS_PANEL;
import static view.GUI.panels.table_panels.MedicationsPanel.MEDICATION_PANEL;
import static view.GUI.panels.table_panels.PatientsPanel.PATIENTS_PANEL;
import static view.GUI.panels.table_panels.StaffMembersPanel.STAFF_MEMBERS_PANEL;
import static view.GUI.panels.table_panels.TreatmentsPanel.TREATMENTS_PANEL;
import static view.GUI.panels.table_panels.VisitsPanel.VISITS_PANEL;
import static view.GUI.panels.table_panels.edit_panels.EditDepartmentPanel.EDIT_DEPARTMENT_PANEL;
import static view.GUI.panels.table_panels.edit_panels.EditMedicalProblemPanel.EDIT_MEDICAL_PROBLEM_PANEL;
import static view.GUI.panels.table_panels.edit_panels.EditMedicationPanel.EDIT_MEDICATION_PANEL;
